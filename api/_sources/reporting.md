...
Implementation of the SCHEMA.md v0.1.2 card lifecycle: load YAML cards,
validate against the 16 schema rules, run them via the appropriate
handler dispatch (algebraic-map vs. dynamical), populate the result
block, and serialise evidence.
