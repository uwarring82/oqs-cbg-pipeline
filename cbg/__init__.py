...
# Protective import-time check: the three mandatory docs/ files must exist.
...
if _missing:
    _warnings.warn(
        ...
        "is structurally non-compliant with Sail v0.4 §11 in this state. "
