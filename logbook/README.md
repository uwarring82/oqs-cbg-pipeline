...
*Last updated: 2026-05-06 (DG-4 PASS at D1 v0.1.2 after v0.1.1 supersedure; picture-fixed Path B with all four reproducibility perturbations operational and audit-complete result JSON). CC-BY-4.0 (see ../LICENSE-docs).*
