...
*Last updated: 2026-05-06 (DG-4 Phase C sweep runner wired; `run_card(D1 v0.1.1)` produces structured CardResult via Path B; no Phase D verdict). CC-BY-4.0 (see ../LICENSE-docs).*
