...
**Version:** v0.4 (Pre-freeze polish; supersedes v0.3)
**Layer:** Sail
...
- **v0.4 (this revision, 2026-04-29)** — pre-freeze polish after Steward + Architect + Scout read of v0.3; six items applied:
...
*End of Sail v0.4. Sail-layer artefact under local stewardship; no Council clearance required. Subject to revision at the steward's discretion; substantive changes that bear on CL-2026-005 must route via fresh Council deliberation per §0 and §9 DG-5.*
